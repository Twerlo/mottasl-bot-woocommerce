...
class Mottasl_Bot_Woocommerce {
	...
	private function load_dependencies() {
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-mottasl-bot-woocommerce-public.php';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Mottasl_Bot_Woocommerce_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Mottasl_Bot_Woocommerce_Public( $this->get_plugin_name(), $this->get_version() );
